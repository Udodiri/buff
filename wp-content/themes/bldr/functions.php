...
// added 10-11-2016
	wp_enqueue_script( 'bldr-sticky-head', get_template_directory_uri() . '/js/bootbox.js', array('jquery'), false, true );
	
	wp_enqueue_script( 'bldr-sticky-head', get_template_directory_uri() . '/js/parsley.js', array('jquery'), false, true );
	
// -------------

	wp_enqueue_script( 'bldr-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	//wp_enqueue_script( 'bldr-my-custom', get_template_directory_uri() . '/js/my-custom.js', array(), '20120206', true );
