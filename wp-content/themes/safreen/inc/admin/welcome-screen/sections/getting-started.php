...
<img class="size-medium wp-image-198 alignleft" src="<?php echo  esc_url(get_template_directory_uri().'/inc/admin/img/front1.jpg');?>" alt="1" width="84" height="300" />
<p style="text-align: center;"><img class="alignleft wp-image-199 size-large" src="<?php echo  esc_url(get_template_directory_uri().'/inc/admin/img/2.png');?>" alt="2" width="630" height="338" /></p>
...
<ul>
 	<li style="text-align: left;"><?php _e('Create 3 pages from pages tab','safreen'); ?></li>
 	...
 	<li style="text-align: left;"><?php _e('now from service block widgets select your page for service block content (screen shot image )','safreen'); ?></li>
</ul>
