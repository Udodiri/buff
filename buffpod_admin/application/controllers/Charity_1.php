...
class Charity extends CI_Controller {
    ...
    public function add_subcharity() {
                ...
                if ($this->form_validation->run() == FALSE)
                {
                            $data['charities'] = $this->Db_model->get_records_by_id("bp_charity",false,"","*","","");
                            if(!empty($prv_c_id)){
                                $data['prv_data'] = $this->Db_model->get_records_by_id("bp_sub_charity",true,array("id"=>$prv_c_id),"*","","");
                            }
                ...
                {
                    $insert_data['charity_id']=$this->input->post('charity_name');
                    $insert_data['sub_charity_name']=$this->input->post('s_charity_name');
                    $insert_data['status']=$this->input->post('status');
